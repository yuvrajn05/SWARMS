...
if __name__ == "__main__":
    ...
    while rclpy.ok():
        if done:
            ...
            # env.change_special_goal_position(real_goal_position)

            ##################################################################################################

            #############################################################################################################################
            goal_position = (0.43, 1.58)
            file_path = '../../../logs/TaskObjectWithAllocation.json'
            ...
            real_goal_position = (x_rounded, y_rounded)

            alloted_bot = data[first_key]["alloted_bot"]

            env.change_special_goal_position(real_goal_position)

            env.change_special_agent_index(alloted_bot)
