...
robot_file = '/home/vatsan/robo/src/ros2_learners/logs/robot_positions.json'  # Change to the actual path of the robot positions file
task_file = '/home/vatsan/robo/src/ros2_learners/logs/TaskObjectLocation.json'    # Change to the actual path of the task position file
