...
def main():
    # Paths to the files
    positions_file = '/home/sid/ros2_ws/src/stamp/stamp/ros_data.json'  # Update with your positions file path
    labels_file = '/home/sid/SmartLLM/logs/TaskObjects.json'  # Update with your classification labels file path
    output_file = '/home/sid/ros2_ws/src/stamp/stamp/ros_data2.json'  # Path to save the output JSON file
